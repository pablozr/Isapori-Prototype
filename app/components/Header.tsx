          ...
          <div className="header-inner">
            ...
            <nav>
              <ul className={`nav-menu ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
                ...
                <li><a href="https://isaporigeneve.wixsite.com/isapori" target="_blank" rel="noopener noreferrer" onClick={closeMobileMenu}>{t('nav.order')}</a></li>
            ...
            <div className="header-actions">
              <LanguageSelector />
              <a href="https://isaporigeneve.wixsite.com/isapori/reservations" target="_blank" rel="noopener noreferrer" className="reservation-supreme"><span>{t('nav.reserve')}</span></a>
            </div>
        ...
        <div className="mobile-menu-overlay" onClick={closeMobileMenu}>
          <div className="mobile-menu-content" onClick={(e) => e.stopPropagation()}>
            ...
            <nav className="mobile-nav">
              ...
              <a href="https://isaporigeneve.wixsite.com/isapori" target="_blank" rel="noopener noreferrer" onClick={closeMobileMenu}>{t('nav.order')}</a>
              <a href="#menu" onClick={closeMobileMenu}>{t('nav.menu')}</a>
              <a href="/contact" onClick={closeMobileMenu}>{t('nav.contact')}</a>
            </nav>
            <div className="mobile-actions">
              <LanguageSelector />
              <a href="https://isaporigeneve.wixsite.com/isapori/reservations" target="_blank" rel="noopener noreferrer" className="mobile-reservation-btn" onClick={closeMobileMenu}>
                {t('nav.reserve')}
              </a>
            </div>
          </div>
